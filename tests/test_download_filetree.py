...
class DownloadTestFileTree(unittest.TestCase):
    ...
    def test_simple_download_list_into_filetree(self):
        ...
        for file in self.__test_urls_image_context_path_list:
            ...
            assert imghdr.what(expected_outfile) == "jpeg" or imghdr.what(expected_outfile) == "jpg" or imghdr.what(expected_outfile) == "png" , "Expected that file "+expected_outfile+" is a image, but it is of type "+str(imghdr.what(expected_outfile))
